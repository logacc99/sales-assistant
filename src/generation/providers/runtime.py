...
class BedrockRuntimeClient(BaseLLMClient):
    ...
    def _resolve_model_id(self, config: GenerationConfig) -> str:
        """Resolves active model ID for Bedrock runtime."""
        return config.model_id or self.app_config.bedrock_generation_model_id
...
BedrockConverseClient = BedrockRuntimeClient
